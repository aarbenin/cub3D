...
/*   Updated: 2024/09/12 07:56:47 by ogoman           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * Handles errors by displaying an appropriate error message and performing
 * necessary cleanup.
 * 
 ...
 * @param info Optional additional information to be displayed along with
 * the error message.
 * @param should_exit Flag indicating whether the program should exit
 * after handling the error.
 * @return Always returns 1 if `should_exit` is true (indicates that
 * an error occurred).
 */
...
int	handle_error(t_cub_err err, t_game *g, char *info, int should_exit)
{
	...
	write(2, "cub3D not run in root of proj\n", 37 * (err == ERR_INV_PATH));
 ...
 * 
 * @param exit_code The exit code to return after displaying the usage
 * information.
 */
...
/**
 * Handles the end of the program by displaying an end-of-program error
 * message and exiting.
 * 
